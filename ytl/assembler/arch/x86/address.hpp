#ifndef YTL_ASSEMBLER_X86_ADDRESS_HPP
#define YTL_ASSEMBLER_X86_ADDRESS_HPP
		...
		namespace x86
		{
			...
			*/
			...
			struct mod_rm
			{
				...
				mod_rm( detail::register_id<N> reg ) // implicit
					: mod_( 3/*0b11*/ )
					, rm_( reg.get() )
				{}
...
//				mod_rm32_disp32,	// mod_rm & disp(4Byte) field
			...
			*/
			...
			template<unsigned int N>
			inline byte_t make_mod_rm( mod_rm<N> const& mod_rm_value, detail::register_id<N> const& reg )
			{
...
#endif /*YTL_ASSEMBLER_X86_ADDRESS_HPP*/